...
extension ServerPacket.Mojang.Java.Handshaking {
    ...
    public struct LegacyServerListPing: ServerPacketMojangJavaHandshakingProtocol {
        public static let id = ServerPacket.Mojang.Java.Handshaking.legacyServerListPing

        @inlinable
        public static func parse(_ packet: inout GeneralPacketMojang) throws -> Self {
            let payload = try packet.readUnsignedByte()
