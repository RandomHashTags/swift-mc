...
extension ClientPacket.Mojang.Java.Play {
    ...
    public struct SetEntityVelocity: ClientPacket.Mojang.Java.PlayProtocol {
        ...
        public static func parse(_ packet: inout GeneralPacketMojang) throws -> Self {
            ...
            let velocityX = try packet.readShort()
            let velocityY = try packet.readShort()
            let velocityZ = try packet.readShort()
